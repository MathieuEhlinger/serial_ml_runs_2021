...
df_fcm_pos_vs_neg_calc= DataSet(our_data_folder, 'df_fcm_pos_vs_neg_calc', dataset_lib= spec_ds_lib,description= 'FCM - Sum of all values for all region at once (+ vs -)').df_data
...
df_fcm_pos_and_neg_calc_er  = DataSet(our_data_folder, 'df_fcm_pos_neg', dataset_lib= spec_ds_lib,description= 'FCM - Sum of all values for each region (+ vs -)').df_data

df_fcm_gens_together=   DataSet(pd.concat([df_fts_ints,df_fcm_org_calc,df_fcm_pos_vs_neg_calc,df_fcm_pos_and_neg_calc],axis=1), 'df_fcm_gens_with_fts_ints', dataset_lib= spec_ds_lib,description= 'FCM - Derived data').df_data
df_fcm_pos_and_neg_calc_er_wg  = DataSet(pd.concat([df_fcm_gens_together,df_fcm_pos_and_neg_calc_er],axis=1), 'df_fcm_paner_inc_gen', dataset_lib= spec_ds_lib,description= 'FCM - General FCM and Sum of all values for each region (+ vs -)').df_data
